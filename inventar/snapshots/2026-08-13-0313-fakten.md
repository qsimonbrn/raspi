...
| Uptime | up 2 weeks, 2 days, 2 hours, 37 minutes |
| Load | 2.75 2.93 1.93 |
| Temperatur | 58.9'C |
| Throttled | 0x0 |
| RAM verfuegbar | 1.5Gi von 3.7Gi |
| Root belegt | 8.7G von 235G (4%) |
...
|---|---|---|---|
| ntfy | binwiederhier/ntfy:latest | Up 7 minutes (healthy) | 0.0.0.0:2586->80/tcp, [::]:2586->80/tcp |
| paperless | ghcr.io/paperless-ngx/paperless-ngx:latest | Up 42 minutes (healthy) | 0.0.0.0:8000->8000/tcp, [::]:8000->8000/tcp |
| paperless-paperless-db-1 | postgres:15 | Up 44 minutes (healthy) | 5432/tcp |
| paperless-paperless-redis-1 | redis:7 | Up 44 minutes | 6379/tcp |
| homepage | ghcr.io/gethomepage/homepage:latest | Up About a minute (healthy) | 0.0.0.0:3000->3000/tcp, [::]:3000->3000/tcp |
| homepage-dockerproxy | ghcr.io/tecnativa/docker-socket-proxy:latest | Up 2 hours | 2375/tcp |
...
| Image | Alter |
|---|---|
| binwiederhier/ntfy:latest | 8 days ago |
...
0.0.0.0:2586 "docker-proxy",pid=1141869,fd=8
...
0.0.0.0:8000 "docker-proxy",pid=1107540,fd=8

...
| Uptime | up 2 weeks, 2 days, 1 hour, 47 minutes |
| Load | 0.82 1.08 0.85 |
| Temperatur | 49.6'C |
| Throttled | 0x0 |
| RAM verfuegbar | 2.3Gi von 3.7Gi |
| Root belegt | 9.3G von 235G (5%) |
...
|---|---|---|---|
| homepage | ghcr.io/gethomepage/homepage:latest | Up 41 minutes (healthy) | 0.0.0.0:3000->3000/tcp, [::]:3000->3000/tcp |
| homepage-dockerproxy | ghcr.io/tecnativa/docker-socket-proxy:latest | Up 43 minutes | 2375/tcp |
...
0.0.0.0:3000 "docker-proxy",pid=1063367,fd=8
...
[::]:3000 "docker-proxy",pid=1063375,fd=8
